pipeline {
  ...
  environment {
    ...
    NightlyEmailList = 'pmills@beckman.com, mbevers@beckman.com'
        ...
        stage('Nigthly build - build'){
          steps {
            ...
            checkout([
              ...
              userRemoteConfigs: [[credentialsId: '30bccc90-3e99-4958-b9a7-e822c26d0cdf', url: 'git@github.com:BeclsParticle/sciencemodule_Deployment.git']]
            ])
